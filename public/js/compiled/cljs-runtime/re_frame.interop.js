...
return [(function (){var pred__19286 = cljs.core.instance_QMARK_;
var expr__19287 = reactive_val;
if(cljs.core.truth_((pred__19286.cljs$core$IFn$_invoke$arity$2 ? pred__19286.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__19287) : pred__19286.call(null,reagent.ratom.RAtom,expr__19287)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19286.cljs$core$IFn$_invoke$arity$2 ? pred__19286.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__19287) : pred__19286.call(null,reagent.ratom.RCursor,expr__19287)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19286.cljs$core$IFn$_invoke$arity$2 ? pred__19286.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__19287) : pred__19286.call(null,reagent.ratom.Reaction,expr__19287)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19286.cljs$core$IFn$_invoke$arity$2 ? pred__19286.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__19287) : pred__19286.call(null,reagent.ratom.Track,expr__19287)))){
return "tr";
} else {
return "other";
}
