...
var sci$impl$types$IBox$setVal$dyn_14673 = (function (_this,_v){
...
return sci$impl$types$IBox$setVal$dyn_14673(_this,_v);
}
});

var sci$impl$types$IBox$getVal$dyn_14674 = (function (_this){
var x__5393__auto__ = (((_this == null))?null:_this);
...
return sci$impl$types$IBox$getVal$dyn_14674(_this);
}
});
...
var sci$impl$types$IReified$getInterfaces$dyn_14681 = (function (_){
...
return sci$impl$types$IReified$getInterfaces$dyn_14681(_);
}
});

var sci$impl$types$IReified$getMethods$dyn_14682 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getMethods$dyn_14682(_);
}
});

var sci$impl$types$IReified$getProtocols$dyn_14689 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getProtocols$dyn_14689(_);
}
});
...
var or__5045__auto____$1 = (function (){var G__14636 = x;
var G__14636__$1 = (((G__14636 == null))?null:cljs.core.meta(G__14636));
if((G__14636__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__14636__$1);
}
})();
...
/** @this {Function} */
(sci.impl.types.type_impl.cljs$lang$applyTo = (function (seq14626){
var G__14627 = cljs.core.first(seq14626);
var seq14626__$1 = cljs.core.next(seq14626);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14627,seq14626__$1);
}));
...
var sci$impl$types$Stack$stack$dyn_14697 = (function (this$){
...
return sci$impl$types$Stack$stack$dyn_14697(this$);
}
});
...
(sci.impl.types.NodeR.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k14641,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k14641,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__14654){
var vec__14655 = p__14654;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14655,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14655,(1),null);
...
(sci.impl.types.NodeR.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__14640){
var self__ = this;
var G__14640__$1 = this;
return (new cljs.core.RecordIter((0),G__14640__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"stack","stack",-793405930)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this14642,other14643){
var self__ = this;
var this14642__$1 = this;
return (((!((other14643 == null)))) && ((((this14642__$1.constructor === other14643.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this14642__$1.f,other14643.f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this14642__$1.stack,other14643.stack)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this14642__$1.__extmap,other14643.__extmap)))))))));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k14641){
var self__ = this;
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__14640){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__14662 = cljs.core.keyword_identical_QMARK_;
var expr__14663 = k__5352__auto__;
if(cljs.core.truth_((pred__14662.cljs$core$IFn$_invoke$arity$2 ? pred__14662.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__14663) : pred__14662.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__14663)))){
return (new sci.impl.types.NodeR(G__14640,self__.stack,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__14662.cljs$core$IFn$_invoke$arity$2 ? pred__14662.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"stack","stack",-793405930),expr__14663) : pred__14662.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),expr__14663)))){
return (new sci.impl.types.NodeR(self__.f,G__14640,self__.__meta,self__.__extmap,null));
} else {
return (new sci.impl.types.NodeR(self__.f,self__.stack,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__14640),null));
}
}
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__14640){
var self__ = this;
var this__5342__auto____$1 = this;
return (new sci.impl.types.NodeR(self__.f,self__.stack,G__14640,self__.__extmap,self__.__hash));
}));
 ...
 */
sci.impl.types.map__GT_NodeR = (function sci$impl$types$map__GT_NodeR(G__14644){
var extmap__5385__auto__ = (function (){var G__14667 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__14644,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"stack","stack",-793405930)], 0));
if(cljs.core.record_QMARK_(G__14644)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__14667);
} else {
return G__14667;
}
})();
return (new sci.impl.types.NodeR(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__14644),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(G__14644),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

sci.impl.types.eval = (function sci$impl$types$eval(expr,ctx,bindings){
if((expr instanceof sci.impl.types.NodeR)){
var fexpr__14670 = expr.f;
return (fexpr__14670.cljs$core$IFn$_invoke$arity$3 ? fexpr__14670.cljs$core$IFn$_invoke$arity$3(expr,ctx,bindings) : fexpr__14670.call(null,expr,ctx,bindings));
} else {
return expr;
}
});
