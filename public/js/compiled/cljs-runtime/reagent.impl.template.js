...
var G__19081 = o;
reagent.impl.template.goog$module$goog$object.set(G__19081,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__19100__i < G__19100__a.length) {G__19100__a[G__19100__i] = arguments[G__19100__i + 0]; ++G__19100__i;}
  args = new cljs.core.IndexedSeq(G__19100__a,0,null);
} 
...
var G__19082 = o;
reagent.impl.template.goog$module$goog$object.set(G__19082,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__19103__i < G__19103__a.length) {G__19103__a[G__19103__i] = arguments[G__19103__i + 0]; ++G__19103__i;}
  args = new cljs.core.IndexedSeq(G__19103__a,0,null);
} 
...
var G__19083 = props;
var G__19083__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19083,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19083);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19083__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__19084 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19084,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__19084;
}
})(),id_class);
...
var G__19085 = (cljs.core.count(argv) - first_child);
switch (G__19085) {
case (0):
...
var vec__19086 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19086,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19086,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19086,(2),null);
...
var temp__5808__auto___19106 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19106 == null)){
} else {
var key_19107 = temp__5808__auto___19106;
(jsprops.key = key_19107);
}
...
var temp__5808__auto___19108 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19108 == null)){
} else {
var key_19109 = temp__5808__auto___19108;
(jsprops.key = key_19109);
}
...
var temp__5808__auto___19110 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19110 == null)){
} else {
var key_19111 = temp__5808__auto___19110;
(jsprops.key = key_19111);
}
...
var temp__5808__auto___19116 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19116 == null)){
} else {
var key_19117 = temp__5808__auto___19116;
(jsprops.key = key_19117);
}
...
var temp__5808__auto___19121 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19121 == null)){
} else {
var key_19122 = temp__5808__auto___19121;
(jsprops.key = key_19122);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19089_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19089_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19090 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19090,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19090,(1),null);
...
break;
default:
var G__19127 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__19128 = compiler;
v = G__19127;
compiler = G__19128;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template19096 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template19096 = (function (opts,id,fn_to_element,parse_fn,meta19097){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template19096.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19098,meta19097__$1){
var self__ = this;
var _19098__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19096(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19097__$1));
}));

(reagent.impl.template.t_reagent$impl$template19096.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19098){
var self__ = this;
var _19098__$1 = this;
return self__.meta19097;
}));

(reagent.impl.template.t_reagent$impl$template19096.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19096.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19096.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19096.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19096.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19096.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19097","meta19097",-721605080,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19096.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19096.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19096");

(reagent.impl.template.t_reagent$impl$template19096.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template19096");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19096.
 */
reagent.impl.template.__GT_t_reagent$impl$template19096 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template19096(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19097){
return (new reagent.impl.template.t_reagent$impl$template19096(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19097));
});

}

return (new reagent.impl.template.t_reagent$impl$template19096(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
