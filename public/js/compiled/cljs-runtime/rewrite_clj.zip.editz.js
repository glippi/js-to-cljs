...
return rewrite_clj.node.protocols.coerce((function (){var G__10593 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__10593) : f.call(null,G__10593));
})());
});
});
/**
...
var len__5769__auto___10605 = arguments.length;
var i__5770__auto___10606 = (0);
while(true){
if((i__5770__auto___10606 < len__5769__auto___10605)){
args__5775__auto__.push((arguments[i__5770__auto___10606]));

var G__10607 = (i__5770__auto___10606 + (1));
i__5770__auto___10606 = G__10607;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__10594_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__10594_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq10595){
var G__10596 = cljs.core.first(seq10595);
var seq10595__$1 = cljs.core.next(seq10595);
var G__10597 = cljs.core.first(seq10595__$1);
var seq10595__$2 = cljs.core.next(seq10595__$1);
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__10598 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__10598) : str_fn.call(null,G__10598));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__10599 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__10599) : str_fn.call(null,G__10599));
})()):null)));
...
var G__10602 = rewrite_clj.zip.base.tag(zloc);
var G__10602__$1 = (((G__10602 instanceof cljs.core.Keyword))?G__10602.fqn:null);
switch (G__10602__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__10600_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__10600_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__10601_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__10601_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10602__$1)].join('')));
...
var G__10604 = rewrite_clj.zip.base.tag(zloc);
var G__10604__$1 = (((G__10604 instanceof cljs.core.Keyword))?G__10604.fqn:null);
switch (G__10604__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__10603_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__10603_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10604__$1)].join('')));
