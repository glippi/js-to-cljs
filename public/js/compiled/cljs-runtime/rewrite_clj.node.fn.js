...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__8961(s__8962){
...
var i = cljs.core._nth(c__5521__auto__,i__8963);
...
cljs.core.chunk_append(b__8964,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__9048 = (i__8963 + (1));
i__8963 = G__9048;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__8964),rewrite_clj$node$fn$fn_walk_$_iter__8961(cljs.core.chunk_rest(s__8962__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__8964),null);
}
} else {
var i = cljs.core.first(s__8962__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__8961(cljs.core.rest(s__8962__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__8956_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__8956_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k8988,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k8988,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__9011){
var vec__9012 = p__9011;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9012,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9012,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__8987){
var self__ = this;
var G__8987__$1 = this;
return (new cljs.core.RecordIter((0),G__8987__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this8990,other8991){
var self__ = this;
var this8990__$1 = this;
return (((!((other8991 == null)))) && ((((this8990__$1.constructor === other8991.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8990__$1.children,other8991.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8990__$1.__extmap,other8991.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k8988){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k8988);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__8987){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__9029 = cljs.core.keyword_identical_QMARK_;
var expr__9030 = k__5352__auto__;
if(cljs.core.truth_((pred__9029.cljs$core$IFn$_invoke$arity$2 ? pred__9029.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__9030) : pred__9029.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__9030)))){
return (new rewrite_clj.node.fn.FnNode(G__8987,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__8987),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__8987){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__8987,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__8993){
var extmap__5385__auto__ = (function (){var G__9033 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__8993,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__8993)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__9033);
} else {
return G__9033;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__8993),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
