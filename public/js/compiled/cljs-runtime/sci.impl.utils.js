...
var map__15262 = cljs.core.meta(iobj);
var map__15262__$1 = cljs.core.__destructure_map(map__15262);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15262__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15262__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15262__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.vars.current_file));
...
var map__15265 = (function (){var or__5045__auto__ = stack;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__15266 = env;
var G__15266__$1 = (((G__15266 == null))?null:cljs.core.deref(G__15266));
var G__15266__$2 = (((G__15266__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__15266__$1));
var G__15266__$3 = (((G__15266__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__15266__$2,id));
var G__15266__$4 = (((G__15266__$3 == null))?null:cljs.core.deref(G__15266__$3));
var G__15266__$5 = (((G__15266__$4 == null))?null:cljs.core.last(G__15266__$4));
if((G__15266__$5 == null)){
return null;
} else {
return cljs.core.meta(G__15266__$5);
}
}
})();
var map__15265__$1 = cljs.core.__destructure_map(map__15265);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15265__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15265__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15265__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var len__5769__auto___15320 = arguments.length;
var i__5770__auto___15321 = (0);
while(true){
if((i__5770__auto___15321 < len__5769__auto___15320)){
args__5775__auto__.push((arguments[i__5770__auto___15321]));

var G__15322 = (i__5770__auto___15321 + (1));
i__5770__auto___15321 = G__15322;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq15270){
var G__15272 = cljs.core.first(seq15270);
var seq15270__$1 = cljs.core.next(seq15270);
var G__15273 = cljs.core.first(seq15270__$1);
var seq15270__$2 = cljs.core.next(seq15270__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15272,G__15273,seq15270__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__15283 = cljs.core.namespace(sym);
switch (G__15283) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__15289 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__15289) : inner.call(null,G__15289));
})(),(function (){var G__15290 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__15290) : inner.call(null,G__15290));
})(),null));
} else {
...
var fexpr__15306 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__15306.cljs$core$IFn$_invoke$arity$2 ? fexpr__15306.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__15306.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__15307_SHARP_){
return f(p1__15307_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__15308 = pred;
var G__15309 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__15308,G__15309) : sci.impl.utils.split_when.call(null,G__15308,G__15309));
})());
} else {
return null;
}
...
var G__15334 = cljs.core.next(params__$1);
var G__15335 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__15336 = lets;
params__$1 = G__15334;
new_params = G__15335;
lets = G__15336;
...
var G__15338 = cljs.core.next(params__$1);
var G__15339 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__15340 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__15338;
new_params = G__15339;
lets = G__15340;
continue;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq15310){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15310));
}));
