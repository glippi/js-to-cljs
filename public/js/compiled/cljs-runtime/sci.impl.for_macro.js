...
var arg_count_17959 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_17959)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Wrong number of args (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_17959),") passed to: clojure.core/for"].join(''),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__17727){
...
var err = (function() { 
var G__17960__delegate = function (msg){
...
while (G__17961__i < G__17961__a.length) {G__17961__a[G__17961__i] = arguments[G__17961__i + 0]; ++G__17961__i;}
  msg = new cljs.core.IndexedSeq(G__17961__a,0,null);
} 
return G__17960__delegate.call(this,msg);};
G__17960.cljs$lang$maxFixedArity = 0;
G__17960.cljs$lang$applyTo = (function (arglist__17962){
var msg = cljs.core.seq(arglist__17962);
return G__17960__delegate(msg);
});
G__17960.cljs$core$IFn$_invoke$arity$variadic = G__17960__delegate;
return G__17960;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__17772){
...
var bind = first__17778;
var first__17778__$1 = cljs.core.first(seq__17777__$1);
var seq__17777__$2 = cljs.core.next(seq__17777__$1);
var expr__$1 = first__17778__$1;
var mod_pairs = seq__17777__$2;
var vec__17779 = seq__17774__$1;
var vec__17782 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17779,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17782,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17782,(1),null);
var next_groups = vec__17779;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__17785){
...
var vec__17789 = first__17788;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17789,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17789,(1),null);
var pair = vec__17789;
var etc = seq__17787__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__17717__auto__","iterys__17717__auto__",1263666156,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__17718__auto__","fs__17718__auto__",-167211339,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__17717__auto__","iterys__17717__auto__",1263666156,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__17718__auto__","fs__17718__auto__",-167211339,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__17718__auto__","fs__17718__auto__",-167211339,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__17813){
var vec__17824 = p__17813;
...
var vec__17827 = first__17826;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17827,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17827,(1),null);
var pair = vec__17827;
var etc = seq__17825__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
