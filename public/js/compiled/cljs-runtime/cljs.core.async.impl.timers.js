...
var i_14138 = (self__.level + (1));
while(true){
if((i_14138 <= (new_level + (1)))){
(update[i_14138] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14141 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14141[i]));
} else {
x__$2.forward.push((((i < links_14141.length))?(links_14141[i]):null));
}

if((i < links_14141.length)){
(links_14141[i] = x__$2);
} else {
links_14141.push(x__$2);
}
...
var i_14143 = (0);
while(true){
if((i_14143 <= self__.level)){
var links_14144 = (update[i_14143]).forward;
if((x__$1 === (((i_14143 < links_14144.length))?(links_14144[i_14143]):null))){
(links_14144[i_14143] = (x__$1.forward[i_14143]));

var G__14146 = (i_14143 + (1));
i_14143 = G__14146;
continue;
} else {
