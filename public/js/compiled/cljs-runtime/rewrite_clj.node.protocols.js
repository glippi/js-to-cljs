...
var rewrite_clj$node$protocols$Node$tag$dyn_8744 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_8744(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_8749 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_8749(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_8750 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_8750(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_8751 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_8751(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_8752 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_8752(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_8753 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_8753(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8655_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__8655_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_8783 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_8783(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_8787 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_8787(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_8788 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_8788(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_8791 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_8791(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_8795 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_8795(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_8820 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_8820(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_8831 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_8831(node);
}
});
...
var map__8706 = cljs.core.meta(node);
var map__8706__$1 = cljs.core.__destructure_map(map__8706);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8706__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8706__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8706__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8706__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__8709,p__8710){
var vec__8712 = p__8709;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8712,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8712,(1),null);
var vec__8715 = p__8710;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8715,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8715,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__8720 = col_extent;
if((row_extent === (0))){
return (G__8720 + col);
} else {
return G__8720;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__8726 = rewrite_clj.node.protocols.children(node);
var G__8726__$1 = (((G__8726 == null))?null:cljs.core.first(G__8726));
if((G__8726__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__8726__$1);
}
} else {
