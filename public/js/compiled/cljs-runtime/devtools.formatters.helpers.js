...
var G__11043 = devtools.prefs.pref(v);
v = G__11043;
continue;
} else {
return v;
...
}catch (e11013){var _e__10351__auto__ = e11013;
return false;
}})();
...
}catch (e11018){var _e__10351__auto__ = e11018;
return false;
}})();
...
}catch (e11020){var _e__10351__auto__ = e11020;
return false;
}}
}
});
...
var vec__11034 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11034,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11034,(1),null);
...
return cljs.core.some((function (p1__11037_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11037_SHARP_);
}),template);
});
