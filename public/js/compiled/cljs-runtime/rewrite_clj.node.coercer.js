...
var G__10438 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__10439 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__10438;
lines = G__10439;
continue;
} else {
...
var comma_10440 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_10441 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_10440),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__10433){
var vec__10434 = p__10433;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10434,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10434,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_10441,rewrite_clj.node.protocols.coerce(v),comma_10440);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__10437 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
