...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k10201,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k10201,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__10209){
var vec__10210 = p__10209;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10210,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10210,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this10202,other10203){
var self__ = this;
var this10202__$1 = this;
return (((!((other10203 == null)))) && ((((this10202__$1.constructor === other10203.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this10202__$1.tag,other10203.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this10202__$1.prefix,other10203.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this10202__$1.children,other10203.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this10202__$1.__extmap,other10203.__extmap)))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var vec__10221 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
var mta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10221,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10221,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k10201){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k10201);

}
}));

(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__10200){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__10230 = cljs.core.keyword_identical_QMARK_;
var expr__10231 = k__5352__auto__;
if(cljs.core.truth_((pred__10230.cljs$core$IFn$_invoke$arity$2 ? pred__10230.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__10231) : pred__10230.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__10231)))){
return (new rewrite_clj.node.meta.MetaNode(G__10200,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__10230.cljs$core$IFn$_invoke$arity$2 ? pred__10230.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__10231) : pred__10230.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__10231)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__10200,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__10230.cljs$core$IFn$_invoke$arity$2 ? pred__10230.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__10231) : pred__10230.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__10231)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__10200,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__10200),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__10200){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__10200,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__10206){
var extmap__5385__auto__ = (function (){var G__10238 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__10206,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__10206)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__10238);
} else {
return G__10238;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__10206),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__10206),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__10206),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
