...
var G__10666 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__10666__$1 = (((G__10666 == null))?null:cljs.core.iterate((function (loc){
...
var G__10666__$2 = (((G__10666__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__10666__$1));
var G__10666__$3 = (((G__10666__$2 == null))?null:cljs.core.last(G__10666__$2));
if((G__10666__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__10666__$3);
}
} else {
return zloc;
}
...
var G__10695 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__10696 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__10695;
parent = G__10696;
continue;
} else {
var G__10697 = rewrite_clj.zip.move.right(zloc_map_value);
var G__10698 = parent;
loc = G__10697;
parent = G__10698;
continue;
...
var G__10701 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__10702 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__10701;
parent = G__10702;
continue;
} else {
var G__10704 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__10705 = parent;
loc = G__10704;
parent = G__10705;
continue;
...
var G__10683 = zloc;
var G__10683__$1 = (((G__10683 == null))?null:rewrite_clj.zip.move.down(G__10683));
var G__10683__$2 = (((G__10683__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__10683__$1,k));
if((G__10683__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__10683__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__10684 = zloc;
var G__10684__$1 = (((G__10684 == null))?null:rewrite_clj.zip.move.down(G__10684));
var G__10684__$2 = (((G__10684__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__10684__$1));
var G__10684__$3 = (((G__10684__$2 == null))?null:rewrite_clj.zip.move.down(G__10684__$2));
var G__10684__$4 = (((G__10684__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__10684__$3,k));
if((G__10684__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__10684__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__10685 = rewrite_clj.zip.move.down(zloc);
var G__10685__$1 = (((G__10685 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__10685));
if((G__10685__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__10685__$1);
}
})(),k);
