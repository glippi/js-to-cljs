...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__8429_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__8429_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__8429_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__8438){
var vec__8439 = p__8438;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8439,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8439,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__8444,s,color,element,idx){
var map__8445 = p__8444;
var map__8445__$1 = cljs.core.__destructure_map(map__8445);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8445__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8445__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8445__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__8448 = (function (){var or__5045__auto__ = color;
...
var fexpr__8447 = (function (){var G__8449 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__8449) : style_map.call(null,G__8449));
})();
return (fexpr__8447.cljs$core$IFn$_invoke$arity$1 ? fexpr__8447.cljs$core$IFn$_invoke$arity$1(G__8448) : fexpr__8447.call(null,G__8448));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__8454){
var vec__8455 = p__8454;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8455,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8455,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8455,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__8460){
var vec__8461 = p__8460;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8461,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8461,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8461,(2),null);
...
var vec__8477 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8477,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8477,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8477,(2),null);
...
var G__8638 = cljs.core.next(remaining_cvec);
var G__8639 = new_idx;
var G__8640 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__8638;
idx = G__8639;
out = G__8640;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__8504,cursor_vec){
var vec__8505 = p__8504;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8505,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8505,(1),null);
var focus_vec = vec__8505;
...
var vec__8508 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8508,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8508,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(color_fn,p__8521){
var vec__8522 = p__8521;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8522,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8522,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__8555,existing_count){
var vec__8556 = p__8555;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8556,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8556,(1),null);
...
return cljs.core.filterv((function (p1__8547_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__8547_SHARP_))));
...
var vec__8588 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8588,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8588,(1),null);
var cvec_element = vec__8588;
if((cvec_element == null)){
var G__8657 = cljs.core.next(cvec_nl);
var G__8658 = (idx + (1));
var G__8659 = start;
var G__8660 = out;
cvec_nl = G__8657;
...
var G__8661 = cljs.core.next(cvec_nl);
var G__8662 = (idx + (1));
var G__8663 = idx;
var G__8664 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__8661;
idx = G__8662;
start = G__8663;
out = G__8664;
...
var G__8666 = cljs.core.next(cvec_nl);
var G__8667 = (idx + (1));
var G__8668 = (idx + (1));
var G__8669 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__8666;
idx = G__8667;
start = G__8668;
out = G__8669;
...
var G__8671 = cljs.core.next(cvec_nl);
var G__8672 = (idx + (1));
var G__8673 = idx;
...
var G__8675 = cljs.core.next(cvec_nl);
var G__8676 = (idx + (1));
var G__8677 = start;
var G__8678 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__8675;
idx = G__8676;
start = G__8677;
out = G__8678;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__8596_SHARP_,p2__8595_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__8595_SHARP_)){
return cljs.core.reduced(p1__8596_SHARP_);
} else {
return (p1__8596_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__8601,p__8602){
var vec__8603 = p__8601;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8603,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8603,(1),null);
var vec__8606 = p__8602;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8606,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8606,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__8624,cvec,focus_vec){
var map__8625 = p__8624;
var map__8625__$1 = cljs.core.__destructure_map(map__8625);
var options = map__8625__$1;
var map__8626 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8625__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__8626__$1 = cljs.core.__destructure_map(map__8626);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8626__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8626__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8626__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8623_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__8623_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
