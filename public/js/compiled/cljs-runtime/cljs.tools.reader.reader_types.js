...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7353 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7353(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7355 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7355(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7357 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7357(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7358 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7358(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7368 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7368(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7369 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7369(reader);
}
});
...
var G__7398 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__7399 = s.append(c);
c = G__7398;
s = G__7399;
continue;
}
