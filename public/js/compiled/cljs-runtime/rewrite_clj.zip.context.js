...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__11945_SHARP_){
var G__11946 = rewrite_clj.custom_zipper.core.node(p1__11945_SHARP_);
if((!((G__11946 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__11946.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__11946.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__11946);
} else {
return false;
}
}
