...
var _PERCENT_ = (function (){var ws_pred_fn = (function (p1__10576_SHARP_){
var and__5043__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__10576_SHARP_);
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__10576_SHARP_));
} else {
return and__5043__auto__;
}
});
return rewrite_clj.zip.removez.remove_with_trim(zloc,(function (p1__10580_SHARP_){
return rewrite_clj.zip.removez.left_ws_trim.cljs$core$IFn$_invoke$arity$2(p1__10580_SHARP_,ws_pred_fn);
}),(function (p1__10581_SHARP_){
return rewrite_clj.zip.removez.right_ws_trim.cljs$core$IFn$_invoke$arity$2(p1__10581_SHARP_,ws_pred_fn);
}));
})();
if(cljs.core.truth_(_PERCENT_)){
} else {
