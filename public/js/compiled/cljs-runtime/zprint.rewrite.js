...
var G__13916 = rewrite_clj.zip.next(n);
loc = G__13916;
continue;
} else {
var G__13917 = rewrite_clj.zip.next(loc);
loc = G__13917;
continue;
}
} else {
var G__13918 = rewrite_clj.zip.next(loc);
loc = G__13918;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__13888 = zloc;
var G__13888__$1 = (((G__13888 == null))?null:rewrite_clj.zip.node(G__13888));
if((G__13888__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__13888__$1);
}
})())));
});
/**
...
var G__13921 = rewrite_clj.zip.down(nloc);
nloc = G__13921;
continue;
}
break;
...
var G__13922 = rewrite_clj.zip.right(nloc);
var G__13923 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__13922;
out = G__13923;
continue;
} else {
...
var G__13924 = rewrite_clj.zip.right(replaced_loc);
var G__13925 = cljs.core.next(new_loc);
var G__13926 = replaced_loc;
nloc = G__13924;
new_loc = G__13925;
last_loc = G__13926;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__13913_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__13913_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__13913_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
