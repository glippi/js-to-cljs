...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k10295,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__10304 = k10295;
var G__10304__$1 = (((G__10304 instanceof cljs.core.Keyword))?G__10304.fqn:null);
switch (G__10304__$1) {
case "pattern":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k10295,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__10305){
var vec__10306 = p__10305;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10306,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10306,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__10294){
var self__ = this;
var G__10294__$1 = this;
return (new cljs.core.RecordIter((0),G__10294__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this10296,other10297){
var self__ = this;
var this10296__$1 = this;
return (((!((other10297 == null)))) && ((((this10296__$1.constructor === other10297.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this10296__$1.pattern,other10297.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this10296__$1.__extmap,other10297.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k10295){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k10295);

}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__10294){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__10318 = cljs.core.keyword_identical_QMARK_;
var expr__10319 = k__5352__auto__;
if(cljs.core.truth_((pred__10318.cljs$core$IFn$_invoke$arity$2 ? pred__10318.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__10319) : pred__10318.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__10319)))){
return (new rewrite_clj.node.regex.RegexNode(G__10294,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__10294),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__10294){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__10294,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__10298){
var extmap__5385__auto__ = (function (){var G__10324 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__10298,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_(G__10298)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__10324);
} else {
return G__10324;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__10298),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
