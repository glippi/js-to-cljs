...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__10460 = cljs.core.get_global_hierarchy;
return (fexpr__10460.cljs$core$IFn$_invoke$arity$0 ? fexpr__10460.cljs$core$IFn$_invoke$arity$0() : fexpr__10460.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__10461_SHARP_){
var _STAR_delimiter_STAR__orig_val__10462 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__10463 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__10463);

try{return rewrite_clj.parser.core.parse_next(p1__10461_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__10462);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___10474 = arguments.length;
var i__5770__auto___10475 = (0);
while(true){
if((i__5770__auto___10475 < len__5769__auto___10474)){
args__5775__auto__.push((arguments[i__5770__auto___10475]));

var G__10476 = (i__5770__auto___10475 + (1));
i__5770__auto___10475 = G__10476;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__10468){
var vec__10469 = p__10468;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10469,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq10464){
var G__10465 = cljs.core.first(seq10464);
var seq10464__$1 = cljs.core.next(seq10464);
var G__10466 = cljs.core.first(seq10464__$1);
var seq10464__$2 = cljs.core.next(seq10464__$1);
var G__10467 = cljs.core.first(seq10464__$2);
var seq10464__$3 = cljs.core.next(seq10464__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10465,G__10466,G__10467,seq10464__$3);
}));
...
var G__10472 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__10472)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__10472)){
...
return cljs.core.cons((function (){var G__10473 = rewrite_clj.reader.peek(reader);
switch (G__10473) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__10472)){
