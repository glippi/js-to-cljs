...
var G__8492 = clojure.zip.node(loc);
var fexpr__8491 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__8491.cljs$core$IFn$_invoke$arity$1 ? fexpr__8491.cljs$core$IFn$_invoke$arity$1(G__8492) : fexpr__8491.call(null,G__8492));
});
/**
...
var G__8494 = clojure.zip.node(loc);
var fexpr__8493 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__8493.cljs$core$IFn$_invoke$arity$1 ? fexpr__8493.cljs$core$IFn$_invoke$arity$1(G__8494) : fexpr__8493.call(null,G__8494));
} else {
...
var fexpr__8501 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__8501.cljs$core$IFn$_invoke$arity$2 ? fexpr__8501.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__8501.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__8513 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8513,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8513,(1),null);
var vec__8516 = clojure.zip.children(loc);
var seq__8517 = cljs.core.seq(vec__8516);
var first__8518 = cljs.core.first(seq__8517);
var seq__8517__$1 = cljs.core.next(seq__8517);
var c = first__8518;
var cnext = seq__8517__$1;
var cs = vec__8516;
...
var vec__8525 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8525,(0),null);
var map__8528 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8525,(1),null);
var map__8528__$1 = cljs.core.__destructure_map(map__8528);
var path = map__8528__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8528__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8528__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8528__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8528__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8528__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__8532 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8532,(0),null);
var map__8535 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8532,(1),null);
var map__8535__$1 = cljs.core.__destructure_map(map__8535);
var path = map__8535__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8535__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__8536 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8535__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__8537 = cljs.core.seq(vec__8536);
var first__8538 = cljs.core.first(seq__8537);
var seq__8537__$1 = cljs.core.next(seq__8537);
var r = first__8538;
var rnext = seq__8537__$1;
var rs = vec__8536;
...
var vec__8542 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8542,(0),null);
var map__8545 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8542,(1),null);
var map__8545__$1 = cljs.core.__destructure_map(map__8545);
var path = map__8545__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8545__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8545__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__8551 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8551,(0),null);
var map__8554 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8551,(1),null);
var map__8554__$1 = cljs.core.__destructure_map(map__8554);
var path = map__8554__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8554__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8554__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__8563 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8563,(0),null);
var map__8566 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8563,(1),null);
var map__8566__$1 = cljs.core.__destructure_map(map__8566);
var path = map__8566__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8566__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8566__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__8567 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8567,(0),null);
var map__8570 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8567,(1),null);
var map__8570__$1 = cljs.core.__destructure_map(map__8570);
var path = map__8570__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8570__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__8571 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8571,(0),null);
var map__8574 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8571,(1),null);
var map__8574__$1 = cljs.core.__destructure_map(map__8574);
var path = map__8574__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8574__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__8578 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8578,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8578,(1),null);
...
var len__5769__auto___8627 = arguments.length;
var i__5770__auto___8628 = (0);
while(true){
if((i__5770__auto___8628 < len__5769__auto___8627)){
args__5775__auto__.push((arguments[i__5770__auto___8628]));

var G__8629 = (i__5770__auto___8628 + (1));
i__5770__auto___8628 = G__8629;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq8581){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8582,G__8583,seq8581__$2);
}));
...
var G__8631 = clojure.zip.rightmost(child);
loc__$1 = G__8631;
continue;
} else {
return loc__$1;
...
var vec__8597 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8597,(0),null);
var map__8600 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8597,(1),null);
var map__8600__$1 = cljs.core.__destructure_map(map__8600);
var path = map__8600__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8600__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8600__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8600__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8600__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__8633 = clojure.zip.rightmost(child);
loc__$1 = G__8633;
continue;
} else {
return loc__$1;
