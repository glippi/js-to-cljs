...
if((c === "\n")){
var G__10446 = escape_QMARK_;
var G__10447 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__10446;
lines = G__10447;
continue;
} else {
buf.append(c);

var G__10448 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__10449 = lines;
escape_QMARK_ = G__10448;
lines = G__10449;
continue;
