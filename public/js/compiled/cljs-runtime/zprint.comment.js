...
var G__13100 = (cljs.core.truth_(next_lf)?cljs.core.subs.cljs$core$IFn$_invoke$arity$2(input,(next_lf + (1))):null);
var G__13101 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,chunk);
input = G__13100;
out = G__13101;
continue;
}
...
var G__13106 = moving_up;
var G__13107 = (total_up + up_size);
ploc = G__13106;
total_up = G__13107;
continue;
}
...
var vec__12904 = zprint.comment.left_or_up(zloc);
var up_size = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12904,(0),null);
var next_zloc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12904,(1),null);
var ploc = next_zloc;
...
var vec__12911 = zprint.comment.left_or_up(ploc);
var up_size__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12911,(0),null);
var next_zloc__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12911,(1),null);
if(cljs.core.truth_(length_right_of_newline)){
return (length_right_of_newline + indent_before);
} else {
var G__13115 = next_zloc__$1;
var G__13116 = ((indent_before + cljs.core.count(zstr)) + up_size__$1);
ploc = G__13115;
indent_before = G__13116;
continue;
}
}
break;
...
while(true){
var vec__12919 = (function (){var tnloc = (zprint.zfns.ztag.cljs$core$IFn$_invoke$arity$1 ? zprint.zfns.ztag.cljs$core$IFn$_invoke$arity$1(nloc) : zprint.zfns.ztag.call(null,nloc));
...
var tnloc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12919,(0),null);
var spaces__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12919,(1),null);
if((tnloc == null)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tnloc,new cljs.core.Keyword(null,"newline","newline",1790071323))){
var G__13121 = rewrite_clj.zip.left_STAR_(nloc);
var G__13122 = spaces__$1;
var G__13123 = true;
nloc = G__13121;
spaces = G__13122;
passed_nl_QMARK_ = G__13123;
continue;
} else {
...
var G__13126 = rewrite_clj.zip.left_STAR_(nloc);
var G__13127 = (rewrite_clj.zip.length(nloc) + spaces__$1);
var G__13128 = passed_nl_QMARK_;
nloc = G__13126;
spaces = G__13127;
passed_nl_QMARK_ = G__13128;
continue;
...
var seq_after_space = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__12924_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12924_SHARP_," ");
}),rev_seq);
...
var seq_after_space = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__12925_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12925_SHARP_," ");
 ...
 */
zprint.comment.wrap_comment = (function zprint$comment$wrap_comment(width,p__12928,start){
var vec__12929 = p__12928;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12929,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12929,(1),null);
var stype = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12929,(2),null);
var element = vec__12929;
 ...
 */
zprint.comment.loc_vec = (function zprint$comment$loc_vec(start,p__12934){
var vec__12935 = p__12934;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12935,(0),null);
...
var G__13150 = cljs.core.next(element_vec);
var G__13151 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(element_vec));
element_vec = G__13150;
out = G__13151;
continue;
}
break;
 ...
 */
zprint.comment.fzprint_wrap_comments = (function zprint$comment$fzprint_wrap_comments(p__12942,style_vec){
var map__12943 = p__12942;
var map__12943__$1 = cljs.core.__destructure_map(map__12943);
var options = map__12943__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12943__$1,new cljs.core.Keyword(null,"width","width",-384071477));
...
var vec__12944 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,index);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(2),null);
...
var indent_index = zprint.comment.find_element_from_end((function (p1__12947_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__12947_SHARP_,new cljs.core.Keyword(null,"indent","indent",-148200125))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__12947_SHARP_,new cljs.core.Keyword(null,"newline","newline",1790071323))));
}),style_vec);
 ...
 */
zprint.comment.fzprint_inline_comments = (function zprint$comment$fzprint_inline_comments(p__12953,style_vec){
var map__12954 = p__12953;
var map__12954__$1 = cljs.core.__destructure_map(map__12954);
var options = map__12954__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12954__$1,new cljs.core.Keyword(null,"width","width",-384071477));
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(options))){
...
var vec__12974 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12974,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12974,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12974,(2),null);
var element = vec__12974;
var vec__12977 = cljs.core.second(cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12977,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12977,(1),null);
var ne = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12977,(2),null);
var nn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12977,(3),null);
var next_element = vec__12977;
var vec__12980 = last_out;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(0),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(1),null);
var le = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(2),null);
...
var G__13172 = cljs.core.next(cvec);
var G__13173 = new_element;
var G__13174 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_element);
cvec = G__13172;
last_out = G__13173;
out = G__13174;
continue;
...
var vec__13010 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13010,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13010,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13010,(2),null);
var spaces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13010,(3),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13010,(4),null);
var element = vec__13010;
...
var G__13179 = cljs.core.next(cvec);
var G__13180 = (index + (1));
var G__13181 = null;
var G__13182 = (cljs.core.truth_(last_indent)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_seq,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)):(function(){throw (new Error(["find-aligned-inline-comments a:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__13183 = current_column;
var G__13184 = (0);
var G__13185 = out;
cvec = G__13179;
index = G__13180;
last_indent = G__13181;
current_seq = G__13182;
current_column = G__13183;
distance = G__13184;
out = G__13185;
continue;
} else {
var G__13187 = cljs.core.next(cvec);
var G__13188 = (index + (1));
var G__13189 = null;
var G__13190 = (cljs.core.truth_(last_indent)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)], null):(function(){throw (new Error(["find-aligned-inline-comments b:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__13191 = start_column;
var G__13192 = (0);
var G__13193 = (((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out);
cvec = G__13187;
index = G__13188;
last_indent = G__13189;
current_seq = G__13190;
current_column = G__13191;
distance = G__13192;
out = G__13193;
continue;
}
...
var G__13197 = cljs.core.next(cvec);
var G__13198 = (index + (1));
var G__13199 = index;
var G__13200 = cljs.core.PersistentVector.EMPTY;
var G__13201 = (0);
var G__13202 = (0);
var G__13203 = (((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out);
cvec = G__13197;
index = G__13198;
last_indent = G__13199;
current_seq = G__13200;
current_column = G__13201;
distance = G__13202;
out = G__13203;
continue;
} else {
var G__13204 = cljs.core.next(cvec);
var G__13205 = (index + (1));
var G__13206 = index;
var G__13207 = current_seq;
var G__13208 = current_column;
var G__13209 = (distance + (1));
var G__13210 = out;
cvec = G__13204;
index = G__13205;
last_indent = G__13206;
current_seq = G__13207;
current_column = G__13208;
distance = G__13209;
out = G__13210;
continue;
}
} else {
var G__13211 = cljs.core.next(cvec);
var G__13212 = (index + (1));
var G__13213 = last_indent;
var G__13214 = current_seq;
var G__13215 = current_column;
var G__13216 = distance;
var G__13217 = out;
cvec = G__13211;
index = G__13212;
last_indent = G__13213;
current_seq = G__13214;
current_column = G__13215;
distance = G__13216;
out = G__13217;
continue;
...
var vec__13032 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13032,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13032,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13032,(2),null);
var element = vec__13032;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"comment-inline","comment-inline",712944405))){
var G__13222 = cljs.core.next(cvec);
var G__13223 = (index + (1));
var G__13224 = null;
var G__13225 = (cljs.core.truth_(last_indent)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_seq,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)):(function(){throw (new Error(["find-consecutive-inline-comments:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__13226 = out;
cvec = G__13222;
index = G__13223;
last_indent = G__13224;
current_seq = G__13225;
out = G__13226;
continue;
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"indent","indent",-148200125))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"newline","newline",1790071323))))){
var G__13227 = cljs.core.next(cvec);
var G__13228 = (index + (1));
var G__13229 = index;
var G__13230 = (cljs.core.truth_(last_indent)?cljs.core.PersistentVector.EMPTY:current_seq);
var G__13231 = (cljs.core.truth_(last_indent)?(((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out):out);
cvec = G__13227;
index = G__13228;
last_indent = G__13229;
current_seq = G__13230;
out = G__13231;
continue;
} else {
var G__13233 = cljs.core.next(cvec);
var G__13234 = (index + (1));
var G__13235 = last_indent;
var G__13236 = current_seq;
var G__13237 = out;
cvec = G__13233;
index = G__13234;
last_indent = G__13235;
current_seq = G__13236;
out = G__13237;
continue;
 ...
 */
zprint.comment.comment_column = (function zprint$comment$comment_column(p__13043,style_vec){
var vec__13044 = p__13043;
var indent_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13044,(0),null);
var comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13044,(1),null);
...
var G__13242 = zprint.comment.loc_vec(column,cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,index));
index = G__13241;
column = G__13242;
continue;
}
 ...
 */
zprint.comment.comment_vec_column = (function zprint$comment$comment_vec_column(style_vec,p__13051){
var vec__13053 = p__13051;
var indent_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13053,(0),null);
var inline_comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13053,(1),null);
var comment_vec = vec__13053;
...
var minimum_vec = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13063_SHARP_){
return ((cljs.core.second(p1__13063_SHARP_) - cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__13063_SHARP_,(2))) + (1));
}),comment_vec);
 ...
 *   at a new column.
 */
zprint.comment.change_start_column = (function zprint$comment$change_start_column(new_start_column,style_vec,p__13070){
var vec__13073 = p__13070;
var inline_comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13073,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13073,(1),null);
var spaces_before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13073,(2),null);
var comment_vec = vec__13073;
...
var vec__13077 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,previous_element_index);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13077,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13077,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13077,(2),null);
var previous_element = vec__13077;
