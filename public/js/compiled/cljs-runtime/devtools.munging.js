...
var o10775 = temp__5802__auto__;
var temp__5802__auto____$1 = (o10775["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o10776 = temp__5802__auto____$1;
return (o10776["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10344__auto__ = f;
return (o__10344__auto__["toString"]).call(o__10344__auto__);
} else {
return "";
}
}catch (e10777){var _ = e10777;
return "";
}});
...
try{var o__10344__auto___10921 = t;
(o__10344__auto___10921["cljs$lang$ctorPrWriter"]).call(o__10344__auto___10921,t,writer);
}catch (e10778){var __10922 = e10778;
}
...
var char_code = (function (){var o__10344__auto__ = (new String(char$));
return (o__10344__auto__["charCodeAt"]).call(o__10344__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10344__auto__ = String;
return (o__10344__auto__["fromCharCode"]).call(o__10344__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10780 = num_code;
switch (G__10780) {
case (1):
return (185);
...
var o__10344__auto__ = String;
return (o__10344__auto__["fromCharCode"]).call(o__10344__auto__,superscript_code);
});
/**
...
}catch (e10787){var _e__10351__auto__ = e10787;
return false;
}})())){
...
var vec__10789 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10789,(0),null);
...
var len__5769__auto___10928 = arguments.length;
var i__5770__auto___10929 = (0);
while(true){
if((i__5770__auto___10929 < len__5769__auto___10928)){
args__5775__auto__.push((arguments[i__5770__auto___10929]));

var G__10930 = (i__5770__auto___10929 + (1));
i__5770__auto___10929 = G__10930;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10797){
var vec__10798 = p__10797;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10798,(0),null);
...
var G__10931 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__10932 = cljs.core.butlast(remaining_tokens);
name_tokens = G__10931;
remaining_tokens = G__10932;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10795){
var G__10796 = cljs.core.first(seq10795);
var seq10795__$1 = cljs.core.next(seq10795);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10796,seq10795__$1);
}));
...
var vec__10807 = cljs.core.split_with((function (p1__10806_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__10806_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10807,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10807,(1),null);
...
var vec__10813 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10813,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10813,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__10937 = cljs.core.rest(remaining_tokens);
var G__10938 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__10937;
name_tokens = G__10938;
continue;
} else {
...
var vec__10824 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10824,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10824,(1),null);
var vec__10827 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10827,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10827,(1),null);
var vec__10830 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10830,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10830,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10830,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10830,(3),null);
...
var vec__10840 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10840,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10840,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10840,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10840,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10840,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10840,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__10843 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10843,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10843,(1),null);
var vec__10846 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10846,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10846,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__10853 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__10853) : devtools.munging.parse_fn_info_deep.call(null,G__10853));
})()));
}
} else {
return fn_info;
...
var G__10944 = (arity + (1));
var G__10945 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10865){
var vec__10866 = p__10865;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10866,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10866,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10873_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__10873_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10874_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__10874_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___10946 = arguments.length;
var i__5770__auto___10947 = (0);
while(true){
if((i__5770__auto___10947 < len__5769__auto___10946)){
args__5775__auto__.push((arguments[i__5770__auto___10947]));

var G__10948 = (i__5770__auto___10947 + (1));
i__5770__auto___10947 = G__10948;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10878){
var vec__10879 = p__10878;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10879,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10875){
var G__10876 = cljs.core.first(seq10875);
var seq10875__$1 = cljs.core.next(seq10875);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10876,seq10875__$1);
}));
...
var G__10884 = arg;
var G__10884__$1 = (((G__10884 instanceof cljs.core.Keyword))?G__10884.fqn:null);
switch (G__10884__$1) {
...
var map__10889 = options;
var map__10889__$1 = cljs.core.__destructure_map(map__10889);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10889__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10889__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10889__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10889__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10890 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10890,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10890,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10890,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10890,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10890,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10890,(5),null);
...
var o__10344__auto__ = f;
return (o__10344__auto__["getBasis"]).call(o__10344__auto__);
});
/**
...
}catch (e10897){var _e__10351__auto__ = e10897;
...
var G__10953 = (obj[cljs.core.first(path)]);
var G__10954 = cljs.core.rest(path);
obj = G__10953;
path = G__10954;
continue;
} else {
...
var _STAR_ = (function (accum,p__10899){
var vec__10900 = p__10899;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10900,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10900,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10905){
var vec__10906 = p__10905;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10906,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10906,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10906,(2),null);
...
var post_process = (function (p__10917){
var vec__10918 = p__10917;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10918,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10918,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10910_SHARP_){
return (obj[cljs.core.first(p1__10910_SHARP_)]);
}),sorted_matches);
